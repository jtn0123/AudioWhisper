...
// Settings-persistence, key/mode/configuration and lifecycle tests, split out of
// PressAndHoldKeyMonitorTests to keep each file and type within SwiftLint limits.
